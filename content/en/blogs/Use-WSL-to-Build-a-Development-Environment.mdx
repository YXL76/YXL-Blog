...
2. `Region` - `Administrative` - `Change system locale`
   ![Region](/images/Use-WSL-to-Build-a-Development-Environment/Region.webp)
...
7. Right click on the terminal - `Properties` to view the current encoding and modify the font.
   ![Properties](/images/Use-WSL-to-Build-a-Development-Environment/Properties.webp)
...
![WSLGit](/images/Use-WSL-to-Build-a-Development-Environment/WSLGit.webp)
...
![wslConfig](/images/Use-WSL-to-Build-a-Development-Environment/wslConfig.webp)

And make sure the following plugins are turned on.

![plugin](/images/Use-WSL-to-Build-a-Development-Environment/plugin.webp)

Select `WSL` in `Environment` in `Toolchains` to enable the `ssh` connection.

![cWSL](/images/Use-WSL-to-Build-a-Development-Environment/cWSL.webp)

But unfortunately, if you are using `Artix`, this doesn't work.

![cError](/images/Use-WSL-to-Build-a-Development-Environment/cError.webp)

We can only use WSL as a remote host.

![cRemoteHost](/images/Use-WSL-to-Build-a-Development-Environment/cRemoteHost.webp)
...
![pythonWSL](/images/Use-WSL-to-Build-a-Development-Environment/pythonWSL.webp)

If you use `Remote Host`, you need to set the path mappings.

![sshMapping](/images/Use-WSL-to-Build-a-Development-Environment/sshMapping.webp)
...
![developmentMapping](/images/Use-WSL-to-Build-a-Development-Environment/developmentMapping.webp)
...
![jupyterNotebook](/images/Use-WSL-to-Build-a-Development-Environment/jupyterNotebook.webp)
...
![docker](/images/Use-WSL-to-Build-a-Development-Environment/docker.webp)
...
![DPI](/images/Use-WSL-to-Build-a-Development-Environment/DPI.webp)
