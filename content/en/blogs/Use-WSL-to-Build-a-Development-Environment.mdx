...
date: 2019-04-12T13:51:30.000Z
archive: 2019
category: Operating System
tags: ["WSL", "Windows", "Development Environment"]
banner: ../../../assets/images/Use-WSL-to-Build-a-Development-Environment/banner.webp
caption:
  children: ももこ@5/30画集
  href: https://www.pixiv.net/artworks/73718366
---
...
2. `Region` - `Administrative` - `Change system locale`
   ![Region](../../../assets/images/Use-WSL-to-Build-a-Development-Environment/Region.webp)
...
7. Right click on the terminal - `Properties` to view the current encoding and modify the font.
   ![Properties](../../../assets/images/Use-WSL-to-Build-a-Development-Environment/Properties.webp)
...
> _The following operations are only for `Artix`_
>
> _Please install the C++ environment first_
...
It's time to discard `cmd` and ~~`Powershell`~~.
...
![WSLGit](../../../assets/images/Use-WSL-to-Build-a-Development-Environment/WSLGit.webp)
...
![wslConfig](../../../assets/images/Use-WSL-to-Build-a-Development-Environment/wslConfig.webp)

And make sure the following plugins are turned on.

![plugin](../../../assets/images/Use-WSL-to-Build-a-Development-Environment/plugin.webp)

Select `WSL` in `Environment` in `Toolchains` to enable the `ssh` connection.

![cWSL](../../../assets/images/Use-WSL-to-Build-a-Development-Environment/cWSL.webp)

But unfortunately, if you are using `Artix`, this doesn't work.

![cError](../../../assets/images/Use-WSL-to-Build-a-Development-Environment/cError.webp)

We can only use WSL as a remote host.

![cRemoteHost](../../../assets/images/Use-WSL-to-Build-a-Development-Environment/cRemoteHost.webp)
...
![pythonWSL](../../../assets/images/Use-WSL-to-Build-a-Development-Environment/pythonWSL.webp)

If you use `Remote Host`, you need to set the path mappings.

![sshMapping](../../../assets/images/Use-WSL-to-Build-a-Development-Environment/sshMapping.webp)
...
![developmentMapping](../../../assets/images/Use-WSL-to-Build-a-Development-Environment/developmentMapping.webp)
...
![jupyterNotebook](../../../assets/images/Use-WSL-to-Build-a-Development-Environment/jupyterNotebook.webp)

- C/C++ (optional)

> _Compilation takes a long time and takes up a lot of space_
...
![docker](../../../assets/images/Use-WSL-to-Build-a-Development-Environment/docker.webp)
...
![DPI](../../../assets/images/Use-WSL-to-Build-a-Development-Environment/DPI.webp)
...
- [_Microsoft/WSL: Issues found on WSL_](https://github.com/microsoft/wsl)
- [_Windows developer feedback site_](https://wpdev.uservoice.com/forums/266908-command-prompt-console-windows-subsystem-for-l)
